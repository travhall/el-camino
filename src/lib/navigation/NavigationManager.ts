...
export class NavigationManager {
  ...
  public isHealthy(): boolean {
    ...
    const noStuckTransition =
      !this.state.isViewTransitionActive ||
      (this.state.lastTransitionStart
        ? Date.now() - this.state.lastTransitionStart < 10000
        : true); // 10 second max
...
export const navigationManager =
  typeof window !== "undefined" ? new NavigationManager() : null;
